...
If your situation involves a DUI or DWI conviction specifically, you're more likely looking at an FR-44 instead, which requires higher coverage limits. Not sure which applies to you? Our [FR-44 vs. SR-22 comparison](/guides/fr44-vs-sr22/) breaks down the difference in detail.

<div class="mid-cta">
  <p>Find out exactly what SR-22 coverage will cost you.</p>
...
|---|---|---|
| Required limits | Florida minimums | Florida minimums (same) |
| State filing required | No | Yes, electronic |
| Common trigger | N/A | Uninsured driving, certain violations, reinstatement |
| Typical duration | N/A | ~3 years, no lapses |
...
See also: [SR-22 Insurance page](/sr22-insurance/) and [Florida Insurance Requirements Explained](/guides/florida-insurance-requirements-explained/).
